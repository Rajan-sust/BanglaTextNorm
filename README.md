...
python3 main.py --text "সভা সকাল ৯:৩০ মিনিটে শুরু হবে।"

# Output: সভা সকাল সাড়ে নয়টায় শুরু হবে।

# Normalize abbreviations
python3 main.py --text "ডা. করিম এবং ডি. আহমেদ উপস্থিত ছিলেন।"

# Output: ডাক্তার করিম এবং ডক্টর আহমেদ উপস্থিত ছিলেন।
```
